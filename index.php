			...
			<div class="col-md-offset-2 col-md-8 col-sm-12">
				<div class="home-thumb">
					<h1 class="wow fadeInUp" data-wow-delay="0.4s">Selamat Datang</h1>
          			<h3 class="wow fadeInUp" data-wow-delay="0.6s">di <strong>Buku Tamu</strong> SMK Negeri<strong> 6 Padang</strong></h3>
          			<a href="#about" class="btn btn-lg btn-default smoothScroll wow fadeInUp hidden-xs" data-wow-delay="0.8s">Isi buku tamu</a>
          			<a href="#kontak" class="btn btn-lg btn-default smoothScroll wow fadeInUp hidden-xs" data-wow-delay="0.8s">Kontak</a>
				</div>
			</div>
...
<div id="about" class="d-flex justify-content-center align-items-center" style="min-height: 100vh;">
  <div class="container">
    ...
    <form id="guestForm" method="post" action="proses.php">
      ...
      <div class="form-group" id="namaInstansiDiv" style="display: none;">
        ...
        <input type="text" class="form-control" id="namaInstansi" name="instansi_name" placeholder="Masukkan Nama Instansi">
      </div>

      <div class="form-group">
        <label for="jumlahTamu">Jumlah Tamu:</label>
        <input type="number" class="form-control" id="jumlahTamu" name="qty" placeholder="Masukkan Jumlah Tamu" required>
      </div>

      <div class="form-group">
        <label for="maksudKunjungan">Maksud Kunjungan:</label>
        <textarea class="form-control" id="maksudKunjungan" name="reason" placeholder="Masukkan Maksud Kunjungan" required></textarea>
      </div>
    ...
    <div class="row">
        ...
        <div class="col-md-offset-2 col-md-8 col-sm-12">
            <div class="section-title">
                ...
                <p class="wow fadeInUp" data-wow-delay="0.6s">Jangan ragu untuk menghubungi kami untuk pertanyaan atau dukungan. Kami siap membantu!</p>
            </div>
